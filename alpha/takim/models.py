...
class Takim (models.Model):
    ...
    renk=models.CharField(default='red', max_length=200)
...
class Sporcu(models.Model):
    ...
    veli=models.CharField(max_length=200)
    veli_telefon=models.CharField(max_length=200)
    veli_eposta=models.EmailField(max_length=200)
    ...
    kalp=models.CharField(null=True,blank=True ,max_length=200)
    sosyal=models.CharField(null=True,blank=True, max_length=200)
    kalabalik=models.CharField(null=True,blank=True ,max_length=200)
    dikkat=models.CharField(null=True,blank=True, max_length=200)
    komut=models.CharField(null=True,blank=True ,max_length=200)
    iliski=models.CharField(null=True,blank=True ,max_length=200)


    yuzme_gecmisi=models.CharField(null=True,blank=True ,max_length=200)
    yuzme_bilgisi=models.CharField(null=True,blank=True ,max_length=200)
    derinlik=models.TextField(choices=YES_NO,default='Hayır' ,max_length=200)
    su_korkusu=models.TextField(choices=YES_NO,default='Hayır' ,max_length=200)
    denizde_yuzme=models.TextField(choices=YES_NO,default='Evet' ,max_length=200)
    neden_yuzme=models.CharField(null=True,blank=True ,max_length=200)
    istek_yuzme=models.CharField(null=True,blank=True ,max_length=200)
    vade_yuzme=models.CharField(null=True,blank=True ,max_length=200)

    ulasim=models.CharField(null=True,blank=True ,max_length=200)
    katilim=models.CharField(null=True,blank=True ,max_length=200)
    diger_spor=models.CharField(null=True,blank=True ,max_length=200)
    aile_not=models.TextField(null=True,blank=True ,max_length=200)
    antrenor_not=models.TextField(null=True,blank=True ,max_length=200)
